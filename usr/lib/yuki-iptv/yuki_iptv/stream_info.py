...
from yuki_iptv.threads import async_gui_blocking_function

logger = logging.getLogger(__name__)

# Adapted from
# https://github.com/linuxmint/hypnotix/blob/master/usr/lib/hypnotix/hypnotix.py
#
# https://github.com/linuxmint/hypnotix/blob/master/debian/copyright
...
def process_stream_info(
    ...
    if stream_information_name:
        ...
        stream_information_label1.setFont(YukiData.YukiGUI.font_bold)
    ...
    stream_information_label2.setFont(YukiData.YukiGUI.font_bold)
...
def open_stream_info():
    if YukiData.playing_channel:
        ...
        stream_info_video_lbl.setFont(YukiData.YukiGUI.font_bold)
        YukiData.YukiGUI.stream_information_layout.addWidget(
        ...
        if not YukiData.YukiGUI.streaminfo_win.isVisible():
            moveWindowToCenter(YukiData.YukiGUI.streaminfo_win)
