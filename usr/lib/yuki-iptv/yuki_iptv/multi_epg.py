...
class MultiEPGWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        try:
            ...
            globals()["_multi_epg_duration_label"] = self.duration_label
            self.name_label = QtWidgets.QLabel()
            globals()["_multi_epg_name_label"] = self.name_label
            self.desc_label = QtWidgets.QLabel()
            globals()["_multi_epg_desc_label"] = self.desc_label
            ...
            self.header_layout.addStretch(1000000)  # FIXME: find better solution
    ...
    def get_channels_page(self, group, page):
        ...
        page_start = (page * self.channels_on_page) - self.channels_on_page
        page_end = page * self.channels_on_page
    ...
    class CellLabel(QtWidgets.QLabel):
        def enterEvent(self, event1):
            try:
                globals()["_multi_epg_duration_label"].setText(self._time)
                globals()["_multi_epg_name_label"].setText(
                    f"{self._category}{self._text}"
                )
                globals()["_multi_epg_desc_label"].setText(self._description)
        ...
        def leaveEvent(self, event1):
            try:
                globals()["_multi_epg_duration_label"].setText("")
                globals()["_multi_epg_name_label"].setText("")
                globals()["_multi_epg_desc_label"].setText("")
    ...
    def set_styles(self):
        try:
            self.duration_label.setFont(YukiData.YukiGUI.font_italic)
            self.name_label.setFont(YukiData.YukiGUI.font_bold)
            self.channel_header_label.setFont(YukiData.YukiGUI.font_bold)
