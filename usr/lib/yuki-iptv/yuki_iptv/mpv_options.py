...
def get_mpv_options(MAIN_WINDOW_TITLE, options, custom_options):
    ...
    try:
        ...
        show_parse_error(MAIN_WINDOW_TITLE, custom_options)
    ...
    try:
        ...
        show_parse_error(MAIN_WINDOW_TITLE, json.dumps(options_custom_array))
