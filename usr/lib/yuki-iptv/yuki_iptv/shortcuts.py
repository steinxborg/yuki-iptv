...
main_shortcuts_translations = {
    ...
    "show_playlist_editor": _("P&laylist editor").replace("&", ""),
...
# fix TypeError: Object of type QKeyCombination
# is not JSON serializable
def fixup_shortcuts(shortcuts):
    return {
        shortcut_name1: (
            shortcut_value1
            if isinstance(shortcut_value1, str)
            else QtGui.QKeySequence(shortcut_value1).toString()
        )
        for (
            shortcut_name1,
            shortcut_value1,
