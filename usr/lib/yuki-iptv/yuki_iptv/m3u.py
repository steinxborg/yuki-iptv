            ...
            if line.startswith("#EXTM3U"):
                ...
                if line:
                    if line.startswith("#"):
                        ...
                        buffer_new = []
                        for line1 in buffer:
                            _line = line1.replace("#", "").lower().strip()
                            if metadata_found and (
                                ...
                                break
                            if (
                                line1.startswith("#EXTINF:")
                                or line1.startswith("#EXTGRP:")
                                or line1.startswith("#EXTLOGO:")
                                or line1.startswith("#EXTVLCOPT:")
                                or line1.startswith("#KODIPROP:")
                            ):
                                metadata_found = True
                                buffer_new.insert(0, line1)
                        for line1 in buffer_new:
                        ...
                        if channel:
                            ...
                            if parsed_channel["cenc_decryption_key"]:
                                parsed_channel["orig_title"] = parsed_channel["title"]
                                parsed_channel[
                                    "title"
