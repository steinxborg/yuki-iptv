...
if __name__ == "__main__":
    ...
    try:
        ...
        def channel_settings_save():
            ...
            execute_in_main_thread(partial(YukiGUI.btn_update.click))
        ...
        def idle_prev_channel():
            go_channel(-1)

        def prev_channel():
            execute_in_main_thread(partial(idle_prev_channel))

        def idle_next_channel():
            go_channel(1)

        def next_channel():
            execute_in_main_thread(partial(idle_next_channel))
        ...
        try:
            ...
            def mpris_callback(mpris_data):
                if (
                    ...
                    execute_in_main_thread(partial(win_raise))
                elif (
                    mpris_data[0] == "org.mpris.MediaPlayer2"
