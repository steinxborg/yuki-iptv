...
from yuki_iptv.inhibit import register, inhibit, uninhibit
...
from yuki_iptv.xdg import LOCAL_DIR, CACHE_DIR, SAVE_FOLDER_DEFAULT
    ...
    try:
        ...
        def init_mpv_player():
            ...
            try:
                ...
                logger.warning("mpv init with ytdl / stop_screensaver failed")
                try:
                    YukiData.player = mpv.MPV(
                        **options,
                        osc=YukiData.mpv_osc_enabled,
                    ...
                    logger.warning("mpv init with stop_screensaver failed")
                    try:
                        YukiData.player = mpv.MPV(
                            **options,
                            osc=YukiData.mpv_osc_enabled,
