...
if __name__ == "__main__":
    ...
    try:
        ...
        def xtream_select():
            ...
            moveWindowToCenter(win, YukiGUI.xtream_win)
        ...
        def show_playlists():
            if not YukiGUI.playlists_win.isVisible():
                populate_playlists()
                moveWindowToCenter(win, YukiGUI.playlists_win)
        ...
        def playlists_edit_do(ignore0=False):
            ...
            if ignore0:
                ...
                playlists_data.oldName = ""
                moveWindowToCenter(win, YukiGUI.playlists_win_edit)
        ...
        def init_mpv_player():
            ...
            if YukiData.settings["referer"]:
                referer = YukiData.settings["referer"]
                originURL = ""
                if referer.endswith("/"):
                    originURL = referer[:-1]
                if originURL:
